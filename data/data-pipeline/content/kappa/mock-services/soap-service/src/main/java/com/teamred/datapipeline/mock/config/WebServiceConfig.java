package com.teamred.datapipeline.mock.config;
...
public class WebServiceConfig extends WsConfigurerAdapter {
    ...
    public DefaultWsdl11Definition defaultWsdl11Definition(XsdSchema salesSchema) {
        ...
        wsdl11Definition.setTargetNamespace("http://teamred.com/datapipeline/sales");
    ...
    public XsdSchema salesSchema() {
        return new SimpleXsdSchema(new ClassPathResource("sales.xsd"));
    }
}
